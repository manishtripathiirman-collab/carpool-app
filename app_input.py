...
# Visual Engine: Fixed CSS Stacking Hierarchy for Full Visibility
st.markdown("""
    <style>
    /* Force background to stay strictly behind the components */
    .stApp {
        background: linear-gradient(135deg, rgba(99, 102, 241, 0.35) 0%, rgba(244, 63, 94, 0.4) 50%, rgba(15, 23, 42, 0.95) 100%), 
    ...
    /* Global Text and Element Layer visibility adjustments */
    .mobile-title { font-family: sans-serif; font-size: 28px !important; font-weight: 900; color: #FFFFFF !important; text-shadow: 0px 4px 10px rgba(0,0,0,0.6); margin-bottom: 15px; }
    label, p, span, h2, h3, h4 { color: #FFFFFF !important; font-weight: 600 !important; text-shadow: 0px 2px 4px rgba(0,0,0,0.5); }
    
    /* Dark translucent backing panel to pop inputs away from the gradient background */
    div.stTabs {
    ...
    /* Text Inputs and Dropdown Element Boxes Styling Overrides */
    ...
    /* Dropdown choice menus popover fixing rules */
    div[role="listbox"] { background-color: #0F172A !important; border: 1px solid rgba(255,255,255,0.2) !important; }
    div[role="listbox"] li { color: #FFFFFF !important; font-weight: 600 !important; }
    div[role="listbox"] li:hover { background-color: #1E293B !important; }
    ...
    .stTabs [data-baseweb="tab"] { background-color: rgba(15, 23, 42, 0.8) !important; border: 1px solid rgba(255,255,255,0.1) !important; border-radius: 10px 10px 0px 0px; padding: 10px 20px !important; color: #CBD5E1 !important; font-weight: 700; }
    ...
    .lock-banner { background-color: rgba(15, 23, 42, 0.85); border: 2px solid #EF4444; padding: 25px; border-radius: 20px; text-align: center; margin-bottom: 20px; box-shadow: 0 0 20px rgba(239, 68, 68, 0.3); }
    .future-banner { background-color: rgba(15, 23, 42, 0.85); border: 2px solid #EAB308; padding: 25px; border-radius: 20px; text-align: center; margin-bottom: 20px; box-shadow: 0 0 20px rgba(234, 179, 8, 0.3); }
    </style>
...
# FIXED: Re-anchored the exact state initializers so nothing is clipped off here
