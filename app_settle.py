...
st.markdown(
    ...
    .payout-pill { background: rgba(16, 185, 129, 0.12); color: #10B981; border: 1px solid rgba(16, 185, 129, 0.3); padding: 4px 10px; border-radius: 8px; font-size: 15px; font-weight: 900; }
...
# Performance Scorecards Row (Compact Layout)
...
with tab_payout:
    ...
    <a href="https://api.github.com/../send?text={encoded_message}" data-action="share/whatsapp/share" href="https://api.whatsapp.com/send?text={encoded_message}" target="_blank" class="whatsapp-btn">
        ...
        <div class="eco-box">
            ...
            <div class="scorecard-row" style="margin-top: 6px;">
                <div class="scorecard-box" style="background:rgba(0,0,0,0.25); border:none;">
                    ...
                    <div class="scorecard-val" style="color:#34D399; font-size:16px;">{total_carbon_offset_kg
