...
st.markdown(
    ...
    [data-testid="stAppViewContainer"] { 
        background-color: #0F172A !important; overflow-y: auto !important; 
    }
    .block-container {
        background: rgba(30, 41, 59, 0.5) !important; padding: 15px !important; 
...
st.markdown(
    ...
    .eco-flex-card {
        ...
        padding: 16px; margin-top: 14px; margin-bottom: 10px;
